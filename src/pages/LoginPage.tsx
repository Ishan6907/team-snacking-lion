  ...
  return (
    ...
    >
      ...
      <Box sx={{ py: 1.5, textAlign: 'center', bgcolor: '#ffffff', borderTop: '1px solid #e2e8f0' }}>
        <Typography variant="caption" sx={{ color: '#64748b', fontSize: '0.72rem' }}>
          Problem Statement 11: Explainable AI techniques to ensure transparency in prediction results &bull; Team &lt;INSERT TEAM NAME&gt; &bull; Smart India Hackathon 2026
        </Typography>
      </Box>
    </Box>
  );
