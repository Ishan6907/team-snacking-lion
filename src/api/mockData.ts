import type { ProjectListItem, Project, PaginatedResponse, ProjectFilters } from '@/types/project';
...
const _projects: ProjectListItem[] = PROJECT_NAMES.map((name, i) => {
...
export const mockData = {
  ...
  getProject(id: string): Project {
    const item = _projects.find(p => p.id === id) ?? _projects[0];
